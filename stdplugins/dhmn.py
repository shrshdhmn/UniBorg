...
async def _(event):
    ...
    me = borg.me
    userid = borg.uid
    packname = f"𝘿𝙃𝙈𝙉 // @MeDevilofMarvel"
    packshortname = f"realdhmn"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"𝘿𝙃𝙈𝙉 // @MeDevilofMarvel"
        packshortname = f"Realdhmnani"  # format: Uni_Borg_userid
